...
export class Dbinit1688505050752 implements MigrationInterface {
    name = 'Dbinit1688505050752'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "email" character varying, "password" character varying, "provider" character varying NOT NULL DEFAULT 'email', "socialId" character varying, "firstName" character varying, "lastName" character varying, "hash" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "calendarSettingId" integer, "photoId" uuid, "roleId" integer, "statusId" integer, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "REL_74d52eb0afc6515062829795f4" UNIQUE ("calendarSettingId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users_calendar_events" ("userId" integer NOT NULL, "calendarEventId" integer NOT NULL, CONSTRAINT "PK_781b603a5a80fce696838c44eb1" PRIMARY KEY ("userId", "calendarEventId"))`);
